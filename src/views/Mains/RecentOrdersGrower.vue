  ...
  <div>
    ...
    <v-toolbar flat>
      <v-btn icon v-if="!$vuetify.breakpoint.mdAndUp">
        <v-icon color="grey darken2 grey--text" @click="$router.go(-1)">mdi-arrow-left</v-icon>
      </v-btn>
      <h1 :class="{'headline': $vuetify.breakpoint.smAndDown, 'display-1': $vuetify.breakpoint.mdAndUp}" class="justify-center primary--text font-weight-bold" >Wheat Market</h1>
      <v-spacer></v-spacer>
    </v-toolbar>
                  ...
                  <template slot="headers" slot-scope="props">
                    <tr>
                      <th
                        ...
                        class=""
                      >
                        <span class="v-bid-offer">{{ abbreviate(header.text, 600) }}</span>
