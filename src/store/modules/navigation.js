...
const getters = {
  ...
  footerType: state => state.footer.type,
...
const mutations = {
  ...
  [TOGGLE_FOOTER_TYPE]: (state, payload) => {
    state.footer.type = payload;
  },
...
const actions = {
  ...
  toggleFooterType: ({ commit }, payload) => {
    commit(TOGGLE_FOOTER_TYPE, payload);
  }
};
